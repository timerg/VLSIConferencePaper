...
\begin{table}[htb]
    ...
    \centering
    \label{my-label}
    \caption{Specification of the proposed SiNW readout circuit}
...
($G_{TIA} \times A_{amp}$).
Fig.\ref{fig:noise} shows the measured noise power spectrum referred to the current of the poly-SiNW in our experiments.
